      ...
      parameters: {
        ...
        properties: {
          ...
          radius_meters: {
            type: ["number", "null"],
            description:
              "Search radius in meters (default: 1500, max: 5000). Pass null to use default.",
          },
        },
        required: ["place_type", "radius_meters"],
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          travel_mode: {
            type: ["string", "null"],
            enum: ["walking", "transit", "driving", null],
            description: "Mode of transportation (default: walking). Pass null to use default.",
          },
        },
        required: ["destination_lat", "destination_lng", "travel_mode"],
        additionalProperties: false,
      },
      strict: true,
    },
