...
import { MapPin, Clock, Camera, Check, Locate, Lightbulb, Wallet, AlertTriangle, BookOpen } from "lucide-react";
import { cn, computeDisplayTime, formatDuration } from "../../lib/utils";
import type { ActivityStatus } from "../../lib/utils";
import type { Activity, ActivityLocation, ActivitySpotlight, TimeOfDay } from "../../types/itinerary";
...
export function ActivityCard({
  ...
  return (
    ...
    >
      ...
      {onLocate && hasCoordinates(activity) && !isSelectionMode && (
        <button
          type="button"
