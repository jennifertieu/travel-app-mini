...
function PoseOfTheDayBanner({
  ...
  return (
    <div className="flex items-center gap-4 rounded-xl bg-muted/50 px-4 py-3 transition-opacity duration-300">
...
function SpotInfo({
  ...
  return (
    <div className="w-[340px] flex-shrink-0 flex flex-col gap-5 overflow-y-auto transition-opacity duration-300">
      {/* Header */}
      <div>
...
export function PhotoGuideModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[1000000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-opacity duration-250"
      style={{ opacity: 1 }}
      onClick={onClose}
    >
      <div
        className="bg-background rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] flex flex-col overflow-hidden transition-all duration-250 ease-out"
