...
vi.mock('./useTrip');
const mockUseTrip = useTrip as MockedFunction<typeof useTrip>;
...
describe('useCurrentTrip', () => {
  ...
  it('should invalidate caches when switching trips', async () => {
    ...
    // Note: 'generating-suggestions' removal happens inside an async IIFE after
    // tripCacheManager.switchTrip resolves — not synchronously testable here.
    // The clearCurrentTrip test (below) covers the synchronous removal path.
  });
