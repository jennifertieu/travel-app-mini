...
export const ICON_SVG_PATHS: Record<string, string> = {
  ...
  restaurant:
    '<path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 15V2v0a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3a2 2 0 0 0 2-2V9a5 5 0 0 0-5-5Z"/><path d="M21 15v7"/><path d="M3 15v7"/>',
  bar: '<path d="M8 22h8"/><path d="M7 2h10v20H7z"/><path d="M7 2v20"/><path d="M12 2v20"/><path d="M17 2v20"/>',
  museum:
    '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 3v18"/><path d="M3 7h18"/><path d="M3 11h18"/><path d="M3 15h18"/><path d="M3 19h18"/>',
  park: '<path d="M17 12H7l5-5 5 5z"/><path d="M17 12H7l5 5 5-5z"/><path d="M12 2v20"/>',
  beach:
    '<path d="M2 12h20"/><path d="M2 12c0 5.523 4.477 10 10 10s10-4.477 10-10"/><path d="M12 2c-2.5 0-4.5 2-4.5 4.5S9.5 11 12 11s4.5-2.5 4.5-5S14.5 2 12 2z"/>',
  temple:
    '<path d="M12 2v20"/><path d="M17 2v20"/><path d="M7 2v20"/><path d="M2 7h20"/><path d="M2 12h20"/><path d="M2 17h20"/>',
  market:
    '<path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/>',
  hotel:
    '<path d="M18 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2Z"/><path d="M9 7h6"/><path d="M9 11h6"/><path d="M9 15h6"/>',
  shop: '<path d="M6 2v4"/><path d="M18 2v4"/><path d="M2 8h20"/><path d="M4 8v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"/><path d="M10 14h4"/>',
  landmark:
    '<path d="M3 20h18"/><path d="M6 20V8l6-4 6 4v12"/><path d="M9 12h6"/><path d="M9 16h6"/>',
  attraction:
...
/**
 * Category color configuration for map pins.
 * Each category gets a distinct, vibrant color for the pin body.
 * The icon inside the pin uses the same color on a white circle.
 */
export const CATEGORY_COLORS: Record<
  string,
  { fill: string; shadow: string; label: string }
> = {
  food: { fill: "#FF5A5F", shadow: "rgba(255, 90, 95, 0.35)", label: "Food" },
  sightseeing: {
    fill: "#00A699",
    shadow: "rgba(0, 166, 153, 0.35)",
    label: "Sightseeing",
  },
  nature: {
    fill: "#2ECC71",
  ...
  shopping: {
    fill: "#FC642D",
    shadow: "rgba(252, 100, 45, 0.35)",
    label: "Shopping",
  },
  nightlife: {
    fill: "#7B68EE",
    shadow: "rgba(123, 104, 238, 0.35)",
    label: "Nightlife",
  },
  activity: {
    fill: "#E8553D",
    shadow: "rgba(232, 85, 61, 0.35)",
    label: "Activity",
  },
  stay: {
    fill: "#3B82F6",
...
/**
 * Get the color config for a category.
 * Falls back to "other" if category is not found.
 */
export function getCategoryColor(
  category?: string | null,
): (typeof CATEGORY_COLORS)[string] {
